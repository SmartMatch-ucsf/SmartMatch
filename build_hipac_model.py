...
with open(f"{rae_folder}/Data/20240618/train_test_elective_only_htr.pkl", 'wb') as f:
...
with open(f"{rae_folder}/Models/elective_only_20240618_{model_name}.pkl", 'wb') as f:
